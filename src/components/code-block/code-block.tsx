...
const Root = ({
  ...
  return (
    <CodeBlockContext.Provider value={{ snippets, active, setActive }}>
      <div
        className={clx(
          'flex flex-col overflow-hidden rounded-lg border border-ui-code-border',
          className,
        )}
        {...props}
      >
...
const HeaderComponent = ({
  ...
  return (
    <div
      className={clx(
        'bg-ui-code-bg-header flex items-center gap-2 border-b border-b-ui-code-border px-4 py-3',
        className,
      )}
      {...props}
    >
        ...
        snippets.map((snippet) => (
          <div
            className={clx(
              ...
              {
                'text-ui-code-text-base cursor-default border-ui-code-border bg-ui-code-bg-base':
...
const Body = ({
  ...
  return (
    <div
      className={clx(
        'relative h-full overflow-y-auto bg-ui-code-bg-base p-4',
        className,
      )}
      {...props}
    >
