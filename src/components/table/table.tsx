...
>(({ className, ...props }, ref) => (
  <table
    ref={ref}
    className={clx('txt-compact-small w-full text-ui-fg-subtle', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={clx(
      'txt-compact-small-plus border-y border-ui-border-base [&_tr:hover]:bg-ui-bg-base',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={clx('border-b border-ui-border-base', className)}
    {...props}
  />
))
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={clx(
          'txt-compact-small-plus flex w-full items-center justify-between px-3 py-4 text-ui-fg-subtle',
          className,
        )}
        {...props}
      >
