...
import { EllipseMiniSolid, TrianglesMini } from '~/icons'
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={clx(
      'txt-compact-xsmall-plus px-3 py-2 text-ui-fg-subtle',
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      ref={ref}
      className={clx(
        'grid cursor-pointer grid-cols-[20px_1fr] gap-x-2 rounded-md bg-ui-bg-base px-3 py-2 outline-none transition-colors',
