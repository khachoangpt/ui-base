...
const Portal = Primitives.AlertDialogPortal
  ...
  return (
    <Portal>
      ...
      <Primitives.Content
        ref={ref}
        className={clx(
          'fixed left-[50%] top-[50%] flex w-full max-w-[400px] translate-x-[-50%] translate-y-[-50%] flex-col rounded-lg border bg-ui-bg-base shadow-elevation-flyout focus-visible:outline-none',
...
>(({ className, ...props }, ref) => {
  return (
    <Primitives.Description
      ref={ref}
      className={clx('txt-compact-medium text-ui-fg-subtle', className)}
      {...props}
    />
  )
})
