  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitives.Content
        ref={ref}
        className={clx(
          'fixed inset-y-2 flex w-full flex-1 flex-col rounded-lg border border-ui-border-base bg-ui-bg-base shadow-elevation-modal focus:outline-none max-sm:inset-x-2 max-sm:w-[calc(100%-16px)] sm:right-2 sm:max-w-[560px]',
...
>(({ children, className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className="flex items-start justify-between gap-x-4 border-b border-ui-border-base px-6 py-4"
      {...props}
    >
...
const DrawerFooter = ({
  ...
  return (
    <div
      className={clx(
        'flex items-center justify-end space-x-2 overflow-y-scroll border-t border-ui-border-base px-6 py-4',
        className,
      )}
      {...props}
    />
