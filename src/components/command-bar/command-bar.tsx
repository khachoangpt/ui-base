...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={clx(
        'txt-compact-small-plus px-3 py-2.5 text-ui-contrast-fg-secondary',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={clx('h-10 w-px bg-ui-contrast-border-base', className)}
      {...props}
    />
  )
})
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={clx(
          'txt-compact-small-plus flex items-center gap-x-2 bg-ui-contrast-bg-base px-3 py-2.5 text-ui-contrast-fg-primary outline-none transition-fg',
          'hover:bg-ui-contrast-bg-base-hover focus-visible:bg-ui-contrast-bg-highlight focus-visible:hover:bg-ui-contrast-bg-base-hover active:bg-ui-contrast-bg-base-pressed focus-visible:active:bg-ui-contrast-bg-base-pressed disabled:!bg-ui-bg-disabled disabled:!text-ui-fg-disabled',
