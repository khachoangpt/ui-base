...
import { CalendarIcon, Minus } from '~/icons'
    ...
    return (
      <Primitives.Trigger asChild>
        <button
          ...
          {...props}
        >
          <CalendarIcon className="h-5 w-5 text-ui-fg-muted" />
  ...
  return (
    <Primitives.Portal>
      <Primitives.Content
        ...
        align="center"
        className={clx(
          'txt-compact-small w-fit rounded-lg bg-ui-bg-base shadow-elevation-flyout',
          ...
          <li key={index} className="w-full">
            <button
              className={clx(
                ...
                'text-ui-fg-subtle outline-none transition-all hover:bg-ui-bg-base-hover',
        ...
        <div className="flex">
          <div className="flex items-start">
            ...
            <div>
              ...
              <div className="flex items-center gap-x-2 border-t border-ui-border-base p-3">
                <Button
                  variant="secondary"
                  size="small"
                  className="w-full"
        ...
        <div className="flex">
          <div className="flex items-start">
            ...
            <div>
              ...
              />
              {showTimePicker && (
                <div className="flex items-center justify-evenly gap-x-3 border-t border-ui-border-base p-3">
                  ...
                  <Minus className="h-5 w-5 text-ui-fg-muted" />
                  <div className="flex flex-1 items-center gap-x-2">
                    <span className="text-ui-fg-subtle">
              ...
              <div className="flex items-center justify-between border-t p-3">
                <p className={clx('txt-compact-small-plus text-ui-fg-subtle')}>
